...
$count = "select count(*) from zl_tel where tel='".$tel
	 ...
	 <div class="container">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					该手机号已经发过便民信息，您可以在搜索框输入“手机号”查看。为避免信息重复，目前一个便民电话只能拥有一条便民信息。您可以删除旧的信息，再重新发布。
				</div>
			</div>
	</div>
	<?php	
}else{
	$sql = "insert into zl_tel (tel,leixing,title,description,create_time,modify_time,build_time,status,userid)
	...
	?>
	 ...
	 <div class="container">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					您的信息已提交，便民信息需要系统审核，<span style="color:red">正常情况下会在24小时内审核。审核通过后，方能显示。如需提前审核，请拨打本站电话</span>
