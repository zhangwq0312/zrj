	...
	<div class="col-md-12">  
		<div class="panel panel-default" >
			<div class="panel-heading" style="background-color:#fff;">
				<i class="glyphicon glyphicon-volume-up"></i>&nbsp;尚未使用的券
			</div>
			<div class="panel-body" >
						<?php		
							$sql = "select * from  z_coupon_user where  status=0 and gid=".$coupon_id." and gid in ( select id from z_coupon where userid=".$_SESSION['tel'].")";
