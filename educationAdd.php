	...
	<div class="col-md-9">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" id="defaultForm" <?php if(!isMobile()){?>class="form-horizontal"<?php }?>  action="/educationAddSubmit.php" method="POST">
				  <div class="form-group">
					...
					<div class="col-md-3">
							...
							<?php	
				$sql = "select id,name,value from t_type where group_name='education' and status =0 order by order_num";
...
<?php }?>	
				  ...
				  <div class="form-group">
					...
					<div class="col-md-8">
					  <input type="text" class="form-control" id="title" name="title" placeholder="简明扼要，如：永泰小区13号楼*单元*层，开了初三数学培训班"  />
